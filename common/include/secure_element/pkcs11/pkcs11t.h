...
/* The following IOT-related defines relate to the CKA_IOT_FORMAT attribute */
#define CK_IOT_FORMAT_DECIMAL      0
#define CK_IOT_FORMAT_HEXADECIMAL  1
#define CK_IOT_FORMAT_ALPHANUMERIC 2
#define CK_IOT_FORMAT_BINARY       3

/* The following IOT-related defines relate to the CKA_IOT_..._REQUIREMENT attributes */
#define CK_IOT_PARAM_IGNORED       0
#define CK_IOT_PARAM_OPTIONAL      1
#define CK_IOT_PARAM_MANDATORY     2
...
#define CKA_IOT_FORMAT                0x00000220
#define CKA_IOT_LENGTH                0x00000221
#define CKA_IOT_TIME_INTERVAL         0x00000222
#define CKA_IOT_USER_FRIENDLY_MODE    0x00000223
#define CKA_IOT_CHALLENGE_REQUIREMENT 0x00000224
#define CKA_IOT_TIME_REQUIREMENT      0x00000225
#define CKA_IOT_COUNTER_REQUIREMENT   0x00000226
#define CKA_IOT_PIN_REQUIREMENT       0x00000227
#define CKA_IOT_COUNTER               0x0000022E
#define CKA_IOT_TIME                  0x0000022F
#define CKA_IOT_USER_IDENTIFIER       0x0000022A
#define CKA_IOT_SERVICE_IDENTIFIER    0x0000022B
#define CKA_IOT_SERVICE_LOGO          0x0000022C
#define CKA_IOT_SERVICE_LOGO_TYPE     0x0000022D
...
#define CKM_HIOT_KEY_GEN               0x00000290
#define CKM_HIOT                       0x00000291
...
#define CKR_NEXT_IOT                          0x000001B1
...
typedef CK_ULONG CK_IOT_PARAM_TYPE;
typedef CK_IOT_PARAM_TYPE CK_PARAM_TYPE; /* B/w compatibility */

typedef struct CK_IOT_PARAM {
    CK_IOT_PARAM_TYPE type;
    CK_VOID_PTR pValue;
    CK_ULONG ulValueLen;
} CK_IOT_PARAM;

typedef CK_IOT_PARAM CK_PTR CK_IOT_PARAM_PTR;

typedef struct CK_IOT_PARAMS {
    CK_IOT_PARAM_PTR pParams;
    CK_ULONG ulCount;
} CK_IOT_PARAMS;

typedef CK_IOT_PARAMS CK_PTR CK_IOT_PARAMS_PTR;

typedef struct CK_IOT_SIGNATURE_INFO {
    CK_IOT_PARAM_PTR pParams;
    CK_ULONG ulCount;
} CK_IOT_SIGNATURE_INFO;

typedef CK_IOT_SIGNATURE_INFO CK_PTR CK_IOT_SIGNATURE_INFO_PTR;

#define CK_IOT_VALUE          0
#define CK_IOT_PIN            1
#define CK_IOT_CHALLENGE      2
#define CK_IOT_TIME           3
#define CK_IOT_COUNTER        4
#define CK_IOT_FLAGS          5
#define CK_IOT_OUTPUT_LENGTH  6
#define CK_IOT_OUTPUT_FORMAT  7

#define CKF_NEXT_IOT          0x00000001
...
#define CKF_USER_FRIENDLY_IOT 0x00000020
